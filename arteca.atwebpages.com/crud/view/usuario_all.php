...
<body>
    ...
    <div class="container">
        ...
        <span style="float:right">
            <a href="?acao=create" class="btn btn-outline-dark" style="border-radius: 10px 10px 0px 0px">Cadastrar novo usuário</a>
        </span>

        </p>


        <table class="table table-dark" style="border-radius: 00px 0px 10px 10px" >
            <thead>
                <tr>
                    <th>#</th>
                    <th>Email</th>
            ...
            <tbody>
                ...
                <?php $i=1; foreach($usuarios AS $usuario){ ?>
                    <tr>
                        ...
                        <td><?=$usuario->nome?></td>
                        <td>
                            <a href="?acao=update&id=<?=$usuario->id?>" class="btn btn-outline-info">Editar</a>
